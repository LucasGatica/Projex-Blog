  ...
  return (
    <div className="min-h-screen relative bg-white dark:bg-gray-900">
      ...
      <div className="max-w-2xl pt-20 pb-32 px-6 text-center mx-auto">
        ...
        Programa de Transformação Digital de Projetos que visa apoiar pesquisadores e extensionistas no desenvolvimento de Soluções Tecnológicas Digitais Inovadoras aplicadas à Problemas Científicos Socialmente Relevantes investigados
